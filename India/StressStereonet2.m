...
x_weight=2;
y_weight=2;
roughness=10; %% inversely related to smoothness of contouring
x_intervals=100;
...
text(-1,0.75,['n=' num2str(length(strike1))],'fontsize', 11)



aphi=sortrows(aphi');  
text(-1,0.95,['A\phi=' num2str(round(100*mean(aphi))/100) '±' num2str(round(100*Aphi_uncert)/100)], 'fontsize',11)



text(-1,0.85,['\sigma_H_m_a_xN' num2str(round(SHmax)) 'E±' num2str(round(SH_uncert)) '°'], 'fontsize',9);
