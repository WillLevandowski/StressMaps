...
%                                                                         %
%*************************************************************************%
function [misfits,stress] = linear_stress_inversion_misfits(strike,dip,rake)
...
stress_vector = lsqr_Lev(A,a_vector);
...
pred_slip=[pred_a(1:N) pred_a(N+1:2*N) pred_a(2*N+1:N*3)];
dot_=0*u1;
for i=1:N
