...
%                                                                         %
%*************************************************************************%
function [tau,misfits,d1,d2,d3,sigma_vector_1,sigma_vector_2,sigma_vector_3,shape_ratio,strike,dip,rake] = statistics_stress_inversion_misfit_dumptau(strike1,dip1,rake1,strike2,dip2,rake2,friction,N_iterations,N_realizations,Dist_keep)
...
%--------------------------------------------------------------------------
misfit=zeros(length(strike1),N_iterations);
for i_iteration = 1:N_iterations
   ...
   [misfits,tau] = linear_stress_inversion_misfits(strike,dip,rake);
    misfit(:,i_iteration)=misfits;
